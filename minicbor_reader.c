...
#define POSITIVE_FN MINICBOR_CONCAT(MINICBOR_GLOBAL_FN_PREFIX, positive_fn)
#define NEGATIVE_FN MINICBOR_CONCAT(MINICBOR_GLOBAL_FN_PREFIX, negative_fn)
#define BYTES_FN MINICBOR_CONCAT(MINICBOR_GLOBAL_FN_PREFIX, bytes_fn)
#define BYTES_PIECE_FN MINICBOR_CONCAT(MINICBOR_GLOBAL_FN_PREFIX, bytes_piece_fn)
#define STRING_FN MINICBOR_CONCAT(MINICBOR_GLOBAL_FN_PREFIX, string_fn)
#define STRING_PIECE_FN MINICBOR_CONCAT(MINICBOR_GLOBAL_FN_PREFIX, string_piece_fn)
#define ARRAY_FN MINICBOR_CONCAT(MINICBOR_GLOBAL_FN_PREFIX, array_fn)
#define MAP_FN MINICBOR_CONCAT(MINICBOR_GLOBAL_FN_PREFIX, map_fn)
#define TAG_FN MINICBOR_CONCAT(MINICBOR_GLOBAL_FN_PREFIX, tag_fn)
#define SIMPLE_FN MINICBOR_CONCAT(MINICBOR_GLOBAL_FN_PREFIX, simple_fn)
#define FLOAT_FN MINICBOR_CONCAT(MINICBOR_GLOBAL_FN_PREFIX, float_fn)
#define BREAK_FN MINICBOR_CONCAT(MINICBOR_GLOBAL_FN_PREFIX, break_fn)
#define ERROR_FN MINICBOR_CONCAT(MINICBOR_GLOBAL_FN_PREFIX, error_fn)
...
void minicbor_read(minicbor_reader_t *Reader, unsigned char *Bytes, unsigned Available) {
	...
	case MCS_DEFAULT: {
		...
		case 0x38 ... 0x3B:
			...
			break;
		case 0x40 ... 0x57:
			BYTES_FN(Reader->UserData, Byte - 0x40);
		...
		case 0x5F:
			...
			break;
		case 0x60 ... 0x77:
			STRING_FN(Reader->UserData, Byte - 0x60);
